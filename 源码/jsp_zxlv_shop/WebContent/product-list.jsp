...
<body>
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="indexSelect">爱游旅游社-网上旅游路线销售</a> &gt; <a
			href="selectProductList">旅游路线分类</a> &gt; ${title }
	</div>
	<div id="main" class="wrap">
		<div class="lefter">
			<div class="box">
				...
				<dl>
					<dt>
						<a href="selectProductList">全部旅游路线</a>
					</dt>
					<c:forEach var="f" items="${flist}">
						<dt>
	...
	<div id="footer">Copyright &copy; 2021 爱游旅游社-网上旅游路线销售 All Rights
		Reserved. </div>
</body>
</html>
