...
<title>后台管理 - 爱游旅游社-网上旅游路线销售</title>
...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li><a href="productSelect">旅游路线</a></li>
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">爱游旅游社-网上旅游路线销售</a> &gt; 管理后台
</div>
	...
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				...
				<dd><em><a href="productAdd">新增</a></em><a href="productSelect">旅游路线管理</a></dd>
				<dt>订单管理</dt>
	...
	<div class="main">
		...
		<div class="manage">
				<table border="1"  width="600px" height="100px" bordercolor="red">
					<tr align="center">
						<td class="field">旅游路线名称</td>
						<td class="field">旅游路线图片</td>
						<td class="field">旅游路线价格</td>
						<td class="field">购买数量</td>
						<td class="field">旅游路线库存</td>
					</tr>
