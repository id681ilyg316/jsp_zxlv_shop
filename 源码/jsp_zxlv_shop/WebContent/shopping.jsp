...
<div id="position" class="wrap">
	您现在的位置：<a href="index.html">爱游旅游社-网上旅游路线销售</a> &gt; 购物车
</div>
<div class="wrap">
	<div id="shopping">
				...
				<c:forEach var="rs" items="${requestScope.shoplist}">
					...
					<tr id="product_id_1">
						...
						<td class="price" id="price_id_1">
							<span id="priceText" name="priceText" >${rs.es_ep_price}</span><!-- 旅游路线单价 --><input type="hidden" name="sPPrice" value="${rs.es_ep_price}" />
						...
						<td class="number">
							<dl>
								...
								<!-- 旅游路线id --><input type="hidden" name="spID" value="${rs.es_ep_id}" />
	...
	<script type="text/javascript">
		document.write("Cookie中记录的购物车旅游路线ID："+ getCookie("product") + "，可以在动态页面中进行读取");
	</script>
</div>
<div id="footer">
	Copyright &copy; 2021 爱游旅游社-网上旅游路线销售 All Rights Reserved. 
</div>
</body>
</html>
<script>
